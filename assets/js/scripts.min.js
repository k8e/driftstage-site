...
function parallaxIt() {
    // create variables
    var $fwindow = $(window), scrollTop = window.pageYOffset || document.documentElement.scrollTop, $contents = [], $backgrounds = [];
    // for each of content parallax element
    $('[data-type="content"]').each(function(index, e) {
        var $contentObj = $(this);
        $contentObj.__speed = $contentObj.data("speed") || 1, $contentObj.__fgOffset = $contentObj.offset().top, 
        $contents.push($contentObj);
    }), // for each of background parallax element
    $('[data-type="background"]').each(function() {
        var $backgroundObj = $(this);
        $backgroundObj.__speed = $backgroundObj.data("speed") || 1, $backgroundObj.__fgOffset = $backgroundObj.offset().top, 
        $backgrounds.push($backgroundObj);
    }), // update positions
    $fwindow.on("scroll resize", function() {
        scrollTop = window.pageYOffset || document.documentElement.scrollTop, $contents.forEach(function($contentObj) {
...
!function(global, factory) {
    ...
    function adoptValue(value, resolve, reject, noValue) {
        ...
        try {
            ...
            value && jQuery.isFunction(method = value.promise) ? method.call(value).done(resolve).fail(reject) : value && jQuery.isFunction(method = value.then) ? method.call(value, resolve, reject) : // Control `resolve` arguments by letting Array#slice cast boolean `noValue` to integer:
    ...
    function adjustCSS(elem, prop, valueParts, tween) {
        ...
        if (initialInUnit && initialInUnit[3] !== unit) {
            ...
            do {
                ...
                initialInUnit /= scale, jQuery.style(elem, prop, initialInUnit + unit);
    ...
    function defaultPrefilter(elem, props, opts) {
        ...
        propTween = !jQuery.isEmptyObject(props)) || !jQuery.isEmptyObject(orig)) {
 ...
 */
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        deep && copy && (jQuery.isPlainObject(copy) || (copyIsArray = Array.isArray(copy))) ? (copyIsArray ? (copyIsArray = !1, 
            ...
            support.getById = assert(function(el) {
                ...
                if (void 0 !== context.getElementById && documentIsHTML) {
                    ...
                    if (elem) {
                        ...
                        elems = context.getElementsByName(id), i = 0; elem = elems[i++]; ) if ((node = elem.getAttributeNode("id")) && node.value === id) return [ elem ];
                    }
                    return [];
                }
                ...
                CHILD: function(type, what, argument, first, last) {
                    ...
                    return 1 === first && 0 === last ? function(elem) {
                        ...
                        if (parent) {
                            ...
                            // Defend against cloned attroperties (jQuery gh-1709)
                            uniqueCache = outerCache[node.uniqueID] || (outerCache[node.uniqueID] = {}), cache = uniqueCache[type] || [], 
                            nodeIndex = cache[0] === dirruns && cache[1], diff = nodeIndex), !1 === diff) // Use the same loop as above to seek `elem` from the start
 ...
 */
        ...
        remove: function(owner, key) {
            ...
            if (void 0 !== cache) {
                if (void 0 !== key) {
                    ...
                    Array.isArray(key) ? // If key is an array of keys...
    ...
    jQuery.extend({
        ...
        data: function(key, value) {
            ...
            return "object" == typeof key ? this.each(function() {
                ...
                if (elem && void 0 === value) {
                    ...
                    data = dataUser.get(elem, key))) return data;
                    if (void 0 !== (// Attempt to "discover" the data in
                    // HTML5 custom data-* attrs
                    data = dataAttr(elem, key))) return data;
                } else // Set the data...
                this.each(function() {
        ...
        queue: function(elem, type, data) {
            ...
            return type = (type || "fx") + "queue", queue = dataPriv.get(elem, type), data && (!queue || Array.isArray(data) ? queue = dataPriv.access(elem, type, jQuery.makeArray(data)) : queue.push(data)), 
            queue || [];
        },
 ...
 */
    ...
    jQuery.extend({
        ...
        style: function(elem, name, value, extra) {
            ...
            if (elem && 3 !== elem.nodeType && 8 !== elem.nodeType && elem.style) {
                ...
                isCustomProp || (name = finalPropName(origName)), // Gets hook for the prefixed version, then unprefixed version
                ...
                null != value && value === value && (// If a number was passed in, add the unit (except for certain CSS properties)
    ...
    jQuery.each({
        ...
        for (fxNow = jQuery.now(); i < timers.length; i++) // Run the timer and safely remove it when done (allowing for external removal)
 ...
 */
    ...
    jQuery.each([ "ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend" ], function(i, type) {
        ...
        offset: function(options) {
            ...
            if (elem) // Return zeros for disconnected and hidden (display: none) elements (gh-2310)
            // Support: IE <=11 only
            ...
            // Running getBoundingClientRect on a
            // disconnected node in IE throws an error
            return elem.getClientRects().length ? (rect = elem.getBoundingClientRect(), doc = elem.ownerDocument, 
    ...
    e.prototype.load = function(a) {
        ...
        null !== this.options.limit && (b += "&num=" + this.options.limit), null !== this.options.key && (b += "&key=" + this.options.key), 
        d.getJSON(b, a);
        ...
        this.load(function(b) {
            ...
            if (b = a.generateHTMLForEntries(), a.target.append(b.layout), 0 !== b.entries.length) {
        ...
        return d(this.entries).each(function() {
            var c = a.options.offsetStart, f = a.options.offsetEnd;
            c && f ? index >= c && index <= f && a.isRelevant(this, b.entries) && (c = a.evaluateStringForEntry(a.options.entryTemplate, this), 
            b.entries.push(c)) : a.isRelevant(this, b.entries) && (c = a.evaluateStringForEntry(a.options.entryTemplate, this), 
            b.entries.push(c));
        ...
        return d(0 !== d.trim(a).indexOf("<") ? "<div>" + a + "</div>" : a);
        ...
        var c = a, f = this;
        return d(a.match(/(\{.*?\})/g)).each(function() {
            var a = this.toString();
            c = c.replace(a, f.getValueForToken(a, b));
        }), c;
    }, e.prototype.isRelevant = function(a, b) {
        var c = this.getTokenMap(a);
        return !this.options.filter || (!this.options.filterLimit || this.options.filterLimit !== b.length) && this.options.filter(a, c);
    }, e.prototype.getFormattedDate = function(a) {
        return this.options.dateFormatFunction ? this.options.dateFormatFunction(a) : "undefined" != typeof moment ? (a = moment(new Date(a)), 
        a = a.locale ? a.locale(this.options.dateLocale) : a.lang(this.options.dateLocale), 
        a.format(this.options.dateFormat)) : a;
        ...
        return new e(this, a, b, c).render(), this;
    };
}(jQuery), function($) {
    "use strict";
    ...
    Tooltip.VERSION = "3.2.0", Tooltip.DEFAULTS = {
        ...
        if (this.$element.removeAttr("aria-describedby"), this.$element.trigger(e), !e.isDefaultPrevented()) return $tip.removeClass("in"), 
        $.support.transition && this.$tip.hasClass("fade") ? $tip.one("bsTransitionEnd", complete).emulateTransitionEnd(150) : complete(), 
    ...
    Popover.prototype.getDefaults = function() {
        ...
        $tip.find(".popover-title")[this.options.html ? "html" : "text"](title), $tip.find(".popover-content").empty()[// we use append for html objects to maintain js events
...
}(jQuery), parallaxIt(), function() {
    var initHeader, panHeader;
    initHeader = function() {
        var scale, screenHeight, screenWidth;
        return screenWidth = $(window).width(), screenHeight = $(window).height(), screenWidth > 768 ? (scale = screenHeight / 256, 
        $("#sky-bg").css({
            backgroundSize: 1024 * scale + "px " + screenHeight + "px"
        }), $("#far-bg").css({
            backgroundSize: 1024 * scale + "px " + screenHeight + "px"
        }), $("#near-bg").css({
            backgroundSize: 1024 * scale + "px " + screenHeight + "px"
            ...
            backgroundSize: ""
        })), setTimeout(initHeader, 1e3);
    }, panHeader = function(lastTime, currentPan) {
        var callback, currentTime, panSpeed, panTimeout, screenWidth, timeDelta;
        return panSpeed = .015, panTimeout = 20, screenWidth = $(window).width(), currentTime = Date.now(), 
        timeDelta = currentTime - lastTime, screenWidth > 768 ? (currentPan += panSpeed * timeDelta, 
        $("#sky-bg").css({
            "background-position-x": currentPan + "px"
        }), $("#far-bg").css({
            "background-position-x": 1.4 * currentPan + "px"
        }), $("#near-bg").css({
            "background-position-x": 1.7 * currentPan + "px"
        })) : ($("#sky-bg").css({
            ...
            return panHeader(currentTime, currentPan);
        }, setTimeout(callback, panTimeout);
    }, $(document).ready(function() {
        return initHeader(), panHeader(Date.now(), -2800), $(".current-year").text(new Date().getFullYear()), 
        $("#show-gifs").click(function(e) {
            return e.preventDefault(), $("#gif").removeClass("hidden"), $("#webm").addClass("hidden"), 
            $("#gif img").each(function() {
                var img;
                return img = $(this).attr("data-src"), $(this).attr("src", img);
            });
        }), $("#show-webms").click(function(e) {
            return e.preventDefault(), $("#webm").removeClass("hidden"), $("#gif").addClass("hidden");
        });
    });
}.call(this);